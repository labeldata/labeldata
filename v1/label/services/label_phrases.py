...
PHRASES = {
    ...
    'additional_info': [
        # 상담 전화는 **회사마다 다르다.** 기본 목록에 한 회사 번호를 넣어 두면
        # 다른 회사 라벨에 그 번호가 인쇄된다. 번호 자리를 비워 두고, 자기
        # 번호는 문구함(내 문구)에 담아 쓴다.
        ('상담센터', '제품에 대한 문의 사항 및 상담은 종합상담센터 (전화번호)로 연락 주시기 바랍니다.',
         '소비자 상담실 — 번호는 회사마다 다릅니다', 'fas fa-headset', 'primary'),
