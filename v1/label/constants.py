...
DEFAULT_PHRASES = {
    ...
    'cautions': [
        ...
        {'name': '알레르기 주의1', 'content': '이 제품은 알레르기 유발물질(알류, 우유, 땅콩, 대두, 밀, 돼지고기, 복숭아, 토마토, 호두, 닭고기, 쇠고기, 오징어, 조개류 등)을 사용한 제품과 같은 제조시설에서 제조되었습니다.', 'note': '알레르기 주의 1번', 'order': 2},
        {'name': '알레르기 주의2', 'content': '알레르기 유발물질(알류, 우유, 대두, 밀, 땅콩 등)이 혼입될 수 있으니 주의하시기 바랍니다.', 'note': '알레르기 주의 2번', 'order': 3},
        {'name': '재냉동금지', 'content': '이 제품은 냉동식품을 해동한 제품이니 재냉동시키지 마시길 바랍니다.', 'note': '해동 후 판매제품', 'order': 4},
        {'name': '개봉 후 냉장보관', 'content': '개봉 후에는 냉장 보관하시고, 가급적 빠른 시일 내에 드시기 바랍니다.', 'note': '냉장 보관 제품', 'order': 5},
        {'name': '카페인', 'content': '어린이, 임산부, 카페인 민감자는 섭취에 주의해 주시기 바랍니다. 고카페인 함유', 'note': '고카페인 제품', 'order': 6},
        {'name': '주류경고', 'content': '경고 : 지나친 음주는 뇌졸중, 기억력 손상이나 치매를 유발합니다. 임신 중 음주는 기형아 출생 위험을 높입니다. 19세 미만 판매 금지', 'note': '주류', 'order': 7},
        {'name': '질식주의', 'content': '얼려서 드시지 마십시오. 한 번에 드실 경우 질식 위험이 있으니 잘 씹어 드십시오. 5세 이하 어린이 및 노약자는 섭취를 금하여 주십시오.', 'note': '젤리/곤약 제품', 'order': 8},
        {'name': '캔주의', 'content': '개봉 시 캔 절단부분에 손이 닿지 않도록 각별히 주의하십시오.', 'note': '캔 제품', 'order': 9},
        {'name': '씨제거주의', 'content': '기계로 씨를 제거하는 과정에서 씨 또는 씨의 일부가 남아있을 수 있으니 주의해서 드세요.', 'note': '과일 함유 제품', 'order': 10},
        {'name': '전자레인지용1', 'content': '이 제품은 전자레인지 조리가 가능합니다.', 'note': '전자레인지용 1번', 'order': 11},
        {'name': '전자레인지용2', 'content': '포장지를 제거한 후 전자레인지에 넣어 조리하세요.', 'note': '전자레인지용 2번', 'order': 12},
        {'name': '조사처리', 'content': '이 식품은 감마선/전자선으로 조사처리한 제품입니다.', 'note': '방사선 조사 제품', 'order': 13},
    ],
    'additional': [
        ...
        {'name': '알코올', 'content': '이 제품에는 알코올이 포함되어 있습니다. 알코올 함량 ○○%', 'note': '알코올 함유 제품', 'order': 3},
        {'name': '유산균', 'content': '유산균 100,000,000(1억) CFU/g, 유산균 1억 CFU/g', 'note': '유산균 함유 제품', 'order': 4},
        {'name': '해동방법', 'content': '조리 시 해동방법: 자연 해동 후 사용', 'note': '냉동 식재료 조리 시', 'order': 5},
        {'name': '섭취방법', 'content': '1일 2회, 1회 1포를 물과 함께 섭취하십시오.', 'note': '기능성 제품 섭취 방법', 'order': 6},
        {'name': '사용방법', 'content': '기호에 따라 물이나 우유에 타서 드세요.', 'note': '분말 제품 사용 시', 'order': 7},
        {'name': '음용온도', 'content': '차갑게 또는 따뜻하게 음용 가능합니다.', 'note': '액상음료 등 음용안내', 'order': 8},
        {'name': '소비자상담', 'content': '소비자상담실: 080-000-0000', 'note': '문의전화 안내', 'order': 9},
        {'name': '보관기한안내', 'content': '보관상태에 따라 유통기한 이내라도 변질될 수 있습니다.', 'note': '유통기한 관련 안내', 'order': 10},
        {'name': '색상차이', 'content': '천연 원료로 인해 색상 차이가 있을 수 있습니다.', 'note': '천연 원료 제품', 'order': 11},
        {'name': '침전물', 'content': '침전물이 생길 수 있으나 품질에는 이상이 없습니다.', 'note': '액상제품 또는 착즙음료', 'order': 12}
    ]
}
