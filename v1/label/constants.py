...
DEFAULT_PHRASES = {
    ...
    'cautions': [
        ...
        {'name': '알레르기 주의1', 'content': '이 제품은 알레르기 유발물질(난류, 우유, 땅콩, 대두, 밀, 돼지고기, 복숭아, 토마토, 호두, 닭고기, 쇠고기, 오징어, 조개류 등)을 사용한 제품과 같은 제조시설에서 제조되었습니다.', 'note': '알레르기 주의 1번', 'order': 8},
        {'name': '알레르기 주의2', 'content': '알레르기 유발물질(난류, 우유, 대두, 밀, 땅콩 등)이 혼입될 수 있으니 주의하시기 바랍니다.', 'note': '알레르기 주의 2번', 'order': 9},
