...
BOM_HEADERS = ['원료명', '원재료 표시명', '식품유형', '배합비(%)',
               '제조사/수입사', '비고']
BOM_SAMPLE = ['정제수', '정제수', '음용수', '45.5', '(주)가나다', '']
BOM_NOTE = ('세 번째 줄부터 채우세요. 다 채운 뒤 이 표를 통째로 긁어 '
            'BOM 탭에 붙여넣으면 됩니다. 열 순서를 바꾸지 마세요. '
            '배합비는 숫자만 적습니다(% 기호 없이).')

CONTACT_HEADERS = ['이메일', '이름', '회사명', '인허가번호']
CONTACT_SAMPLE = ['hong@example.com', '홍길동', '(주)가나다식품', '20240123456']
CONTACT_NOTE = ('세 번째 줄부터 채우세요. 다 채운 뒤 이 표를 통째로 긁어 '
                '연락처 표에 붙여넣으면 됩니다. 열 순서를 바꾸지 마세요. '
                '이메일이 없는 줄은 저장되지 않습니다.')
